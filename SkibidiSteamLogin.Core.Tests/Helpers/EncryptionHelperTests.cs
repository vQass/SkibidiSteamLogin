...
namespace SkibidiSteamLogin.Core.Tests.Helpers
{
    public class EncryptionHelperTests
    {
        ...
        [Fact]
        public void EncryptPassword_WhitespaceOnlyPassword_ThrowsArgumentNullException()
        {
            // Arrange
            string publicKeyModulus = "";
            string publicKeyExponent = "010001";
        ...
        [Fact]
        public void EncryptPassword_UnicodePassword_ReturnsBase64String()
        {
            // Arrange — generate valid RSA key for testing
        ...
        [Fact]
        public void EncryptPassword_NullRsaData_ThrowsNullReferenceException()
        {
            // Act & Assert
            Assert.Throws<NullReferenceException>(() => EncryptionHelper.EncryptPassword(null, "password"));
        }
